...
const EditProductPage = () => {
    ...
    useEffect(() => {
        dispatch(fetchProductById(id)).unwrap().then((product) => {
			...
			<form onSubmit={handleSubmit} className="space-y-6">
				...
				<div>
					...
					<input
						...
						onChange={(e) =>
							setProductData({ ...productData, discountPrice: Number(e.target.value) })
						}
						className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
						placeholder="Enter product price"
					/>
				...
				<div>
					...
					<input
						...
						onChange={(e) =>
							setProductData({ ...productData, collections: e.target.value })
						}
						className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
